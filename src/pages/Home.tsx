                        ...
                        >
                            ...
                            >
                                <div style={{ fontSize: 13, fontWeight: 900, color: '#92400e', marginBottom: 4 }}>
                                    Inspired by Hindustani practice
                                </div>
                                <div style={{ fontSize: 22, fontWeight: 900, color: '#1f2937', lineHeight: 1.15 }}>
                                    Build swara patterns with taal, laya, and notation preview.
                                </div>
                            </div> */}
                        </div>
                    </section>
